                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>CNIC</label>
                                    <input class="form-control" placeholder="Enter text" name="cnic">
                                </div>
                                <div class="form-group">
                                    <label>NTN#</label>
                                    <input class="form-control" placeholder="Enter text" name="ntn">
                                </div>
                                <div class="form-group">
                                    <label>Gender</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter text" name="postalcode">

                                </div>
                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input class="form-control" placeholder="Enter text" name="mobile">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter text" name="city_state">
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label >Phone Number</label>
                                    <input class="form-control" placeholder="Enter text" name="company_phone">
                                </div>
                                <div class="form-group">
                                    <label >Website</label>
                                    <input class="form-control" placeholder="" name="company_website">
                                </div>
                                <div class="form-group">
                                    <label >Fax Number</label>
                                    <input class="form-control" placeholder="" name="company_fax">
                                </div>
                                <div class="form-group">
                                    <label >Address</label>
