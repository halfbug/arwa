                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="total_amount"><select class="form-control" name="total_amount_currency">
							<option value="PKR">PKR</option>
							<option value="USD">USD</option>
							</select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="form-group col-md-4">
                            <strong>GD Date : </strong>
                            <input class="date form-control"  type="text" id="gd" name="GD_date">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4"></div>
                        <div class="form-group col-md-4">
                            ...
                            <input class="date form-control"  type="text" id="pay" name="payment_date">
                        </div>
                    </div>
