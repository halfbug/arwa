...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header ">Currency Exchange <a href="{{ route('currency-exchange.create') }}"id="btn_add" name="btn_add" class="btn btn-primary pull-right">Add New</a></h1>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        @foreach ($currencyExchange as $tax)
                            <tr class="odd gradeX">
                                <td>{{$tax->name}} </td>
                                <td>{{$tax->value}}</td>
