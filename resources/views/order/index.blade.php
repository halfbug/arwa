...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header ">Sales Order <a href="{{ route('order.create') }}"id="btn_add" name="btn_add" class="btn btn-primary pull-right">Add New</a></h1>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach ($orders as $order)
                            <tr class="odd gradeX">
                                ...
                                <td>{{$order->shippers->company_name}} </td>
                                <td>{{$order->consignees->company_name}}</td>
