                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label >Date</label>
                                    <input class="form-control" id="datepicker" placeholder="" name="date" value="{{date('Y-m-d',$order->date)}}">
                                </div>

                                <div class="form-group">
                                    <label>Shipper</label>
                                    <select class="itemName form-control"  name="shipper">
                                        <option value="{{$order->shipper}}" selected>{{$order->shippers->company_name}}</option>
                                    </select>

                                </div>
                                <div class="form-group">
                                    <label>Consignee</label>
                                    <select class="itemName1 form-control"  name="consignee">
                                        <option value="{{$order->consignee}}" selected>{{$order->consignees->company_name}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Notify Party</label>
                                    <select class="itemName2 notify_party form-control"  name="notify_party">
                                        <option value="{{$order->notify_party}}" selected>{{$order->notifyparties->company_name}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
...
@section('script')
    <script>
        $(function() {
            $('.itemName').val('{{$order->shipper}}').trigger('change');
        });
