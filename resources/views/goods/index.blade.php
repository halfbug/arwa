...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header ">Goods Declarations <a href="{{ route('goods.create') }}"id="btn_add" name="btn_add" class="btn btn-primary pull-right">Add New</a></h1>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                        @foreach ($goods as $tax)
                            <tr class="odd gradeX">
                                <td>{{$tax->declaration_type}} </td>
                                <td>{{$tax->consignor->company_name}},{{$tax->consignee->first_name}}</td>
                                <td>{{$tax->consignee->company_name}},{{$tax->consignee->first_name}}</td>

                                <td class="center">
                                    <form action="{{ route('goods.destroy',$tax->id) }}" method="POST">
